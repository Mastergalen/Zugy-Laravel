<div class="dz-preview dz-processing dz-image-preview @if($thumbnail_id == $image->id) selected @endif dz-complete" data-original-title="" title="" data-image-id="{!! $image->id !!}">
    <div class="dz-image">
